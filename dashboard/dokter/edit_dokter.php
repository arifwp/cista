                    ...
                    <form method="POST" action="edit_proses.php" enctype="multipart/form-data">
                      <input type="hidden" name="id_dokter" value="<?= $data['id_dokter'] ?>">
                        <div class="form-group">
                          <?= '<img src="../../assets/img/foto_dokter/'.$data['foto_dokter'].'" width="120px" height="100px" class="rounded-circle" alt="'.$data['nama_dokter'].'">' ?>
                        </div>
                        <div class="form-group">
                            <label for="customFile" class="form-label custom-file-input">Foto Profil</label>
                            <input class="form-control" type="file" id="customFile" name="pictures" value="<?= $data['foto_dokter'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="alamat"><?= $data['alamat']; ?></textarea>
                        </div>
