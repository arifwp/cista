      ...
      if(isset($_GET['message'])) {
        ...
        if($_GET['message'] == 'delete_success') { ?>
          <script>
            Swal.fire(
              'Sukses!',
              'Berhasil Menghapus Data Dokter',
              'success'
              )
            </script>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="add_dokter.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="show_dokter.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <table id="datatable" class="table table-striped" data-toggle="data-table">
                     ...
                     <tbody>
                       <?php 
                        ...
                        <tr>
                           <td><?= $no++; ?></td>
                           <td><?= '<img src="../../assets/img/foto_dokter/'. $data['foto_dokter'] .'" width="100px" height="100px">'?></td>
                           ...
                           <td>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <a href="edit_dokter.php?id_dokter=<?= $data['id_dokter']; ?>" class="btn btn-warning">Edit</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <!-- Button Trigger -->
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalDelete-<?= $data['id_dokter'];?>">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                width="16" height="16"
                                viewBox="0 0 172 172"
                              ...
                              <!-- Modal -->
                              <div class="modal fade" id="modalDelete-<?= $data['id_dokter'];?>" tabindex="-1" aria-labelledby="exampleModalLabelDelete" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                      <a href="delete.php?id_dokter=<?= $data['id_dokter']; ?>" class="btn btn-danger">Hapus</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
