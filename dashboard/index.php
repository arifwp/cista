                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="pasien/input_pasien.php">
                                  <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="pasien/tampil_pasien.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                  <h1>Hello Devs!</h1>
                                  <p>Selamat datang di aplikasi rekam medis CISTA</p>
                              </div>
                          </div>
                      </div>
                  </div>
                        ...
                        <div class="progress-detail">
                           ...
                           <h4 class="counter">
                              <?php 
                                 ...
                                 $jml_pasien = mysqli_num_rows($pasien);
                                 echo $jml_pasien.' Jiwa';
                              ?>
                           </h4>
                        </div>
                     </div>
                ...
                <div class="card-body">
                    <form action="proses.php" method="POST">
                        <div class="form-group">
                            <label class="form-label" for="exampleInputText1">Nomor Rekam Medis</label>
                            <?php 
                              $query_rm = "SELECT max(id_rm) as IdTerbesar FROM rekammedis";
                              $sql_rm = mysqli_query($con, $query_rm);
                              $data = mysqli_fetch_array($sql_rm);
                              $idrm = $data['IdTerbesar'];

                              $urutan = (int) substr($idrm, 5, 5);
                              $urutan++;

                              $huruf = "RM";
                              $idrm = $huruf . sprintf("%05s", $urutan);
                              echo '<input type="text" name="nomor_rm" class="form-control" id="exampleInputText1" placeholder="Masukkan Nomor Rekam Medis" value="'.$idrm.'" readonly>'
                            ?>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Nama Pasien</label>
                            <select name="pasien" class="form-select mb-3 shadow-none select2">
                            <option selected="">Pilih Pasien</option>
                                 <?php 
                                    $query_pasien = "SELECT * FROM pasien";
                                    $sql_pasien = mysqli_query($con, $query_pasien);
                        ...
                        <div class="form-group">
                            <label class="form-label" for="exampleFormControlTextarea1">Keluhan</label>
                            <textarea class="form-control" name="keluhan" id="exampleFormControlTextarea1" rows="5"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Nama Dokter</label>
                            <select name="dokter" class="form-select mb-3 shadow-none select2">
                            <option selected="">Pilih Dokter</option>
                                 <?php 
                                    $query_dokter = "SELECT * FROM dokter";
                                    $sql_dokter = mysqli_query($con, $query_dokter);
                        ...
                        <div class="form-group">
                            <label class="form-label" for="exampleInputText1">Diagnosa</label>
                            <input type="text" name="diagnosa" class="form-control" id="exampleInputText1" placeholder="Masukkan Diagnosa">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Obat</label>
                            <select multiple name="obat[]" id="obat" class="form-control"  size="7" required>
                            <?php
                            $sql_obat = mysqli_query($con, "SELECT * FROM obat");
                        ...
                        <div class="form-group">
                            ...
                            <select name="poliklinik" class="form-select mb-3 shadow-none select2">
                            <option selected="">Pilih Poliklinik</option>
                                 <?php 
                                    $query_poli = "SELECT * FROM poliklinik";
                                    $sql_poli = mysqli_query($con, $query_poli);
               ...
               <div class="table-responsive">
                  <table id="datatable" class="table table-striped" data-toggle="data-table">
                     ...
                     <tbody>
                        <?php 
                           $no = 0;
                           $query_show = "SELECT * FROM rekammedis
                                          INNER JOIN pasien ON rekammedis.id_pasien = pasien.id_pasien
                                          INNER JOIN dokter ON rekammedis.id_dokter = dokter.id_dokter
                                          INNER JOIN poliklinik ON rekammedis.id_poli = poliklinik.id_poli
                                          ";
                           $sql_rm = mysqli_query($con, $query_show);
                           while($data_show = mysqli_fetch_array($sql_rm)) {
                             $no++;
                        
                        ?>
                        <tr>
                           <td><?= $no ?></td>
                           <td><?= $data_show['id_rm'] ?></td>
                           <td><?= $data_show['nama_pasien'] ?></td>
                           <td><?= $data_show['nama_dokter'] ?></td>
                           <td><?= $data_show['tgl_periksa'] ?></td>
                           <td>
                              
                              <!-- Button trigger modal -->
                              <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalDetail-<?= $data_show['id_rm'];?>">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                width="16" height="16"
                                viewBox="0 0 172 172"
                                style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M65.145,44.1825c-34.45375,9.29875 -59.59531,38.10875 -60.845,39.56c-1.10187,1.29 -1.10187,3.225 0,4.515c1.49156,1.73344 36.93969,42.4625 81.7,42.4625c44.76031,0 80.20844,-40.72906 81.7,-42.4625c1.10188,-1.29 1.10188,-3.225 0,-4.515c-1.24969,-1.45125 -26.39125,-30.24781 -60.845,-39.56c10.19906,6.7725 16.985,18.32875 16.985,31.4975c-0.01344,20.89531 -16.94469,37.84 -37.84,37.84c-20.89531,0 -37.82656,-16.94469 -37.84,-37.84c0,-13.16875 6.78594,-24.725 16.985,-31.4975zM86,58.48c-9.50031,0 -17.2,7.69969 -17.2,17.2c0,9.50031 7.69969,17.2 17.2,17.2c9.50031,0 17.2,-7.69969 17.2,-17.2c0,-9.50031 -7.69969,-17.2 -17.2,-17.2z"></path></g></g></svg>
                              </button>

                              <!-- Modal -->
                              <div class="modal fade" id="modalDetail-<?= $data_show['id_rm'];?>" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <table class="table table-striped">
                                      <?php 
                                      $id_rm_detail = $data_show['id_rm'];
                                          $query_show_modal = "SELECT * FROM rekammedis
                                                          INNER JOIN pasien ON rekammedis.id_pasien = pasien.id_pasien
                                                          INNER JOIN dokter ON rekammedis.id_dokter = dokter.id_dokter
                                                          INNER JOIN poliklinik ON rekammedis.id_poli = poliklinik.id_poli WHERE id_rm='$id_rm_detail' 
                                                          ";
                                          $sql_rm_modal = mysqli_query($con, $query_show_modal);
                                          while($data_show_modal = mysqli_fetch_array($sql_rm_modal)) {
                                        
                                        ?>
                                      <tbody>
                                      <tr>
                                          <td>Nomor Rekam Medis</th>
                                          <td>: <?= $data_show_modal['id_rm'] ?></td>
                                      </tr>
                                      <tr>
                                          <td>Nama Pasien</th>
                                          <td>: <?= $data_show_modal['nama_pasien'] ?></td>
                                      </tr>
                                      <tr>
                                          <td>Keluhan</th>
                                          <td>: <?= $data_show_modal['keluhan'] ?></td>
                                      </tr>
                                      <tr>
                                          <td>Nama Dokter</th>
                                          <td>: <?= $data_show_modal['nama_dokter'] ?></td>
                                      </tr>
                                      <tr>
                                          <td>Diagnosa</th>
                                          <td>: <?= $data_show_modal['diagnosa'] ?></td>
                                      </tr>
                                      <tr>
                                          <td>Obat</th>
                                          <td>
                                          <?php 
                                              ...
                                              $query_show_obat = "SELECT * FROM rm_obat JOIN obat ON rm_obat.id_obat = obat.id_obat WHERE id_rm = '$data_show_modal[id_rm]'";
                                              $sql_show_obat = mysqli_query($con, $query_show_obat);
                                              while($data_show_modal_obat = mysqli_fetch_array($sql_show_obat)) {
                                                echo $data_show_modal_obat['nama_obat']."<br>";
                                              }
                                             ?>
                                          </td>
                                      </tr>
                                      <tr>
                                          ...
                                          <td>: <?= $data_show_modal['nama_poli'] ?></td>
                                      </tr>
                                      <?php
                              ...
                              <div class="modal fade" id="modalEdit-<?= $data_show['id_rm'];?>" tabindex="-1" aria-labelledby="exampleModalLabelEdit" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <?php 
                                        $sql_edit = "SELECT * FROM rekammedis
                                                    INNER JOIN pasien ON rekammedis.id_pasien = pasien.id_pasien
                                                    INNER JOIN dokter ON rekammedis.id_dokter = dokter.id_dokter
                                                    INNER JOIN poliklinik ON rekammedis.id_poli = poliklinik.id_poli WHERE id_rm='$id_rm_detail' 
                                                    ";
                                      ...
                                      <form action="proses_edit.php" method="post">
                                        ...
                                        <div
                                         class="form-group">
                                            <label class="form-label" for="exampleInputText1">Nomor Rekam Medis</label>
                                            <input type="text" name="nomor_rm" class="form-control" id="exampleInputText1" value="<?= $data_edit['id_rm'] ?>" placeholder="Masukkan Nomor Rekam Medis" readonly>
                                        </div>
                                       
                                        <div class="form-group">
                                            <label class="form-label" for="exampleInputText1">Nama Pasien</label>
                                            <select name="pasien" class="form-select mb-3 shadow-none select2" placeholder="Pilih pasien" >
                                            <option value="">Pilih pasien</option>
                                                <?php 
                                                    $query_pasien = "SELECT * FROM pasien";
                                                    $sql_pasien = mysqli_query($con, $query_pasien);
                                                    while($data_pasien = mysqli_fetch_array($sql_pasien)){
                                                      echo '<option value="'.$data_pasien['id_pasien'].'" '.(($data_pasien['id_pasien'] == $data_edit['id_pasien'] )?'selected="selected"':"").'>'.$data_pasien['nama_pasien'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="exampleFormControlTextarea1">Keluhan</label>
                                            <textarea class="form-control" name="keluhan" id="exampleFormControlTextarea1" rows="5"><?= $data_edit['keluhan'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="exampleInputText1">Nama Dokter</label>
                                            <select name="dokter" class="form-select mb-3 shadow-none select2" placeholder="Pilih pasien" >
                                            <option value="">Pilih Dokter</option>
                                                <?php 
                                                    $query_dokter = "SELECT * FROM dokter";
                                                    $sql_dokter = mysqli_query($con, $query_dokter);
                                                    while($data_dokter = mysqli_fetch_array($sql_dokter)){
                                                      echo '<option value="'.$data_dokter['id_dokter'].'" '.(($data_dokter['id_dokter'] == $data_edit['id_dokter'] )?'selected="selected"':"").'>'.$data_dokter['nama_dokter'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="exampleInputText1">Diagnosa</label>
                                            <input type="text" class="form-control" id="exampleInputText1" value="<?= $data_edit['diagnosa'] ?>" name="diagnosa" placeholder="Masukkan Diagnosa">
                                        </div>


                                        <div class="form-group">
                                            <label class="form-label">Obat</label>
                                            <select multiple name="obat[]" id="obat" class="form-control"  size="7">
                                            <?php
                                              // $query_rm_obat = "SELECT * FROM rm_obat";
                                              // $sql_rm_obat = mysqli_query($con, $query_rm_obat);
                                              // while($data_rm_obat = mysqli_fetch_array($sql_rm_obat)) {
                                              //   echo '<input type="text" name="id_rm_obat" value="'. $data_rm_obat['id_rm_obat'] .'">';

                                                // echo '<option value="'.$data_obat['id_rm'].'">'.$data_obat['id_rm_obat'].'</option>';


                                                $sql_obat = mysqli_query($con, "SELECT * FROM obat");
                                                while($data_obat = mysqli_fetch_array($sql_obat)) {
                                                    // echo '<option value="'.$data_obat['id_obat'].'">'.$data_obat['nama_obat'].'</option>';
                                                    echo '<option value="'.$data_obat['id_obat'].'" '.(($data_obat['id_obat'] == $data_edit['id_obat'] )?'selected="selected"':"").'>'.$data_obat['nama_obat'].'</option>';
                                                }
                                              // }
                                            ?>
                                        </select>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="exampleInputText1">Poliklinik</label>
                                            <select name="poli" class="form-select mb-3 shadow-none select2" placeholder="Pilih pasien" >
                                            <option value="">Pilih pasien</option>
                                                <?php 
                                                    $query_poli = "SELECT * FROM poliklinik";
                                                    $sql_poli = mysqli_query($con, $query_poli);
                                                    while($data_poli = mysqli_fetch_array($sql_poli)){
                                                      echo '<option value="'.$data_poli['id_poli'].'" '.(($data_poli['id_poli'] == $data_edit['id_poli'] )?'selected="selected"':"").'>'.$data_poli['nama_poli'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                        </div>
                              ...
                              <!-- Button Trigger -->
                              <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalDelete-<?= $data_show['id_rm'];?>">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                width="16" height="16"
                                viewBox="0 0 172 172"
                                style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M43,28.66667h86v121.83333h-86z" opacity="0.3"></path><path d="M78.83333,129h-14.33333v-78.83333h14.33333zM107.5,129h-14.33333v-78.83333h14.33333zM28.66667,21.5h114.66667v14.33333h-114.66667z"></path><path d="M121.83333,35.83333l-21.5,-21.5h-28.66667l-21.5,21.5z"></path><path d="M121.83333,157.66667h-71.66667c-7.88333,0 -14.33333,-6.45 -14.33333,-14.33333v-121.83333h100.33333v121.83333c0,7.88333 -6.45,14.33333 -14.33333,14.33333zM50.16667,35.83333v107.5h71.66667v-107.5z"></path></g></g></svg> 
                              </button>

                              <!-- Modal -->
                              <div class="modal fade" id="modalDelete-<?= $data_show['id_rm'];?>" tabindex="-1" aria-labelledby="exampleModalLabelDelete" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <a href="delete.php?id_rm=<?= $data_show['id_rm']; ?>" class="btn btn-danger">Hapus</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
