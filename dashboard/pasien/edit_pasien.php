  ...
  <body class="  ">
    ...
    <aside class="sidebar sidebar-default navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../dashboard/pasien/pasien/index.php" class="navbar-brand">
                <!--Logo start-->
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active " href="tampil_pasien.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="../dashboard/dokter/input_dokter.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../dashboard/dokter/tampildatadokter.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
		...
		?>
                <div class="card-body">
                    <form action="edit_proses.php" method="POST">
                            <input type="hidden" class="form-control" id="id_pasien" readonly value="<?=$data['id_pasien'] ?>" placeholder="Masukkan Nama Lengkap" name="id_pasien">
						            <div class="form-group">
                            <label class="form-label" for="label_nama_pasien">Nama Lengkap</label>
                            <input type="text" class="form-control" id="nama_pasien" value="<?=$data['nama_pasien'] ?>" placeholder="Masukkan Nama Lengkap" name="nama_pasien">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="label_nik_pasien">Nomor Induk Kependudukan</label>
                            <input type="number" class="form-control" id="nomor_identitas" value="<?=$data['nomor_identitas'] ?>" placeholder="Masukkan NIK" name="nomor_identitas">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="label_alamat_pasien">Alamat</label>
                            <input type="text" class="form-control" id="alamat" value="<?=$data['alamat'] ?>" rows="5" name="alamat">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="label_nik_pasien">Nomor Telepon</label>
                            <input type="number" class="form-control" id="notelp" value="<?=$data['no_telp'] ?>" placeholder="081234567890" name="no_telp">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary">Submit</button>
							          <a href="tampil_pasien.php" class="btn btn-outline-warning">Kembali ke data</a>
                    </form>
                </div>
				<?php
					}
